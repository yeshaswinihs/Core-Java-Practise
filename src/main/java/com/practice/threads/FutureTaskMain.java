...
//				!futureTask1.isDone() checks for completion of futureTask1,
//				if not done yet, we have called futureTask1.get(),
//				as get method is blocking operation, current thread will wait for futureTask1 
//				to complete.
